...
export const initialMockWatchlist: WatchlistPerson[] = [
  {
    id: 101,
    name: 'Tariq Ahmed',
    notes: 'Prior unauthorized crossing suspect. Multiple attempted breaches near North Sector gate.',
    photoUrl: generateBiometricAvatarSvg('Tariq Ahmed', 101, 3),
    addedAt: now - 86400 * 12, // 12 days ago
    lastMatchedAt: now - 180, // 3 mins ago
    matchCount: 3,
  },
  {
    id: 102,
    name: 'Vikram Singh',
    notes: 'Flagged individual with cross-border movement alert. Identified at Checkpoint Bravo queue.',
    photoUrl: generateBiometricAvatarSvg('Vikram Singh', 102, 2),
    addedAt: now - 86400 * 20, // 20 days ago
    lastMatchedAt: now - 950, // 15 mins ago
    matchCount: 2,
  },
  {
    id: 103,
    name: 'Bilal Hussain',
    notes: 'High-risk evasion subject. Escaped capture along dry riverbed terrain.',
    photoUrl: generateBiometricAvatarSvg('Bilal Hussain', 103, 1),
    addedAt: now - 86400 * 5, // 5 days ago
    lastMatchedAt: now - 4500, // 1h 15m ago
    matchCount: 1,
  },
  {
    id: 104,
    name: 'Rashid Malik',
    notes: 'Suspected contraband courier along southern culvert sector.',
    photoUrl: generateBiometricAvatarSvg('Rashid Malik', 104, 1),
    addedAt: now - 86400 * 35, // 35 days ago
    lastMatchedAt: now - 16800, // ~4.6h ago
    matchCount: 1,
  },
  {
    id: 105,
    name: 'Farooq Dar',
    notes: 'Biometric enrollment completed per intelligence advisory. No recent border activity logged.',
    photoUrl: generateBiometricAvatarSvg('Farooq Dar', 105, 0),
    addedAt: now - 86400 * 8, // 8 days ago
    lastMatchedAt: null,
    matchCount: 0,
  },
  {
    id: 106,
    name: 'Amir Khan',
    notes: 'Monitored associate. Facial scan profile active on all perimeter camera feeds.',
    photoUrl: generateBiometricAvatarSvg('Amir Khan', 106, 0),
    addedAt: now - 86400 * 3, // 3 days ago
    lastMatchedAt: null,
    matchCount: 0,
  },
];
